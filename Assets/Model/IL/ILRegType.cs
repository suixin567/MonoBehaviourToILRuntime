...
{
	static public void RegisterFunctionDelegate(ILRuntime.Runtime.Enviorment.AppDomain appdomain)
	{
	...
	static public void RegisterMethodDelegate(ILRuntime.Runtime.Enviorment.AppDomain appdomain)
	{
	...
	static public void RegisterDelegateConvertor(ILRuntime.Runtime.Enviorment.AppDomain appdomain)
	{
		...
		appdomain.DelegateManager.RegisterDelegateConvertor<System.Predicate<System.Reflection.MethodInfo>>((act) =>
		{
			...
			{
				return ((System.Func<System.Reflection.MethodInfo, System.Boolean>)act)(obj);
			});
		});
		...
		appdomain.DelegateManager.RegisterDelegateConvertor<UnityEngine.Events.UnityAction<libx.AssetRequest>>((act) =>
		{
			return new UnityEngine.Events.UnityAction<libx.AssetRequest>((arg0) =>
			{
				((Action<libx.AssetRequest>)act)(arg0);
			});
		});
	}
